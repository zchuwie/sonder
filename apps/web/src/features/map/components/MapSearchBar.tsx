...
import { LocationPlaceDTO } from "@/features/map/lib/location-types";
...
export function MapSearchBar({ onPlaceSelect }: Props) {
      ...
      <div className="flex items-center gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search places, cities, or memories..."
            autoComplete="off"
            spellCheck={false}
            className="w-full rounded-2xl py-3 pl-9 pr-8 text-sm outline-none transition-all duration-200"
            style={{
